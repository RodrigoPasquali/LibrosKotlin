...
public class LibrosAdapter extends
    ...
    public void onBindViewHolder(@NonNull LibrosViewHolder holder, final int position) {
        holder.txtNombre.setText(libros.get(holder.getAdapterPosition()).getNombre());
        holder.txtAutor.setText(libros.get(holder.getAdapterPosition()).getAutor());
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onItemClickListener.onItemClick(libros.get(holder.getAdapterPosition()));
            }
        });
    }
